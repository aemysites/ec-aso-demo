...
## Environments
- Preview: https://main--ec-aso-demo--aemysites.aem.page/
- Live: https://main--ec-aso-demo--aemysites.aem.live/
- Block Library: https://main--ec-aso-demo--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `ec-aso-demo` directory in your favorite IDE and start coding :)
